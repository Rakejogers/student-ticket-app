  ...
  const handleNotificationToggle = async () => {
    ...
    try {
      if (isSubscribed) {
        ...
        // Directly try to subscribe to notifications without showing installation dialog
        // The app should already be installed at this point or the user is accessing via browser
